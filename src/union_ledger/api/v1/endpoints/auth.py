...
from union_ledger.core.security import (
    create_access_token,
...
def _issue_tokens(user: User, role_values: list[str]) -> TokenResponse:
    """로그인/회원가입/갱신 공통 토큰 발급. refresh 는 회전되어 매번 새로 내려간다."""
...
async def login_for_access_token(
    ...
    return _issue_tokens(user, role_values)
